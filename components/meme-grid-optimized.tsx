...
const MemeDetailModal = dynamic(
  () => import("@/components/meme-detail-modal").then((mod) => ({ default: mod.MemeDetailModal })),
  {
    loading: () => (
...
export default function MemeGridOptimized() {
  ...
  return (
    <>
      <VirtualizedGrid
        ...
        renderItem={(meme, index, isVisible) => (
          <div className="group animate-fadeIn" style={{ animationDelay: `${Math.min(index * 50, 500)}ms` }}>
            <div className="bg-[#002A29] rounded-xl overflow-hidden shadow-lg shadow-black/30 hover:shadow-xl hover:shadow-black/40 transition-all duration-300 h-full border border-teal-900/50 relative">
              <div
